...
{projects.map((project) => (
  <Card
    key={project.id}
    className="group relative flex flex-col items-center justify-between gap-y-4 rounded-lg border p-6 text-center shadow-md hover:shadow-lg transition-all"
  >
